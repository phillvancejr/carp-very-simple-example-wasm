...
int main(int argc, char** argv) {
    ...
    /* let */ {
        ...
        int state = 0;
        SDLApp* _16 = &app; // ref
        Lambda _17 = { .callback = (void*)SDLApp_quit_MINUS_on_MINUS_esc__int, .env = NULL, .delete = NULL, .copy = NULL }; //Sym SDLApp.quit-on-esc__int (LookupGlobal CarpLand AFunction)
        Lambda _18 = { .callback = (void*)tick, .env = NULL, .delete = NULL, .copy = NULL }; //Sym tick (LookupGlobal CarpLand AFunction)
        Lambda _19 = { .callback = (void*)draw__SDLApp_MUL_, .env = NULL, .delete = NULL, .copy = NULL }; //Sym draw__SDLApp* (LookupGlobal CarpLand AFunction)
        SDLApp_run_MINUS_with_MINUS_callbacks__int(_16, _17, _18, _19, state);
        SDLApp_delete(app);
    }
    return 0;
}
